...
import nithra.gift.suggestion.shop.birthday.marriage.imagepicker.util.ExifDataCopier
import nithra.gift.suggestion.shop.birthday.marriage.imagepicker.util.FileUriUtils
    ...
    fun compress(uri: Uri) {
        activity.lifecycleScope.launch {
            ...
            if (res != null) {
                ...
                setError(nithra.gift.suggestion.shop.birthday.marriage.R.string.error_failed_to_compress_image)
            }
        }
    }
