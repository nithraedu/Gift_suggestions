...
public final class CropImage {
   ...
   */
  public static int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;
   ...
   * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} (int, int, Intent)} and can be
  ...
  public static final class ActivityBuilder {
     ...
     */
    public void start(@NonNull Activity activity, int req_code) {
      CROP_IMAGE_ACTIVITY_REQUEST_CODE = req_code;
      mOptions.validate();
