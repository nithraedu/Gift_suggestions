...
import nithra.gift.suggestion.shop.birthday.marriage.Utils_Class.toast_normal
...
class ShopEdit : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        testView!!.setOnClickListener(View.OnClickListener {
        ...
        shopedit()
        IVPreviewImage!!.setOnClickListener(View.OnClickListener { //openSomeActivityForResult();
            val dialog: Dialog
            dialog = Dialog(
                this@ShopEdit,
        ...
        edit_img!!.setOnClickListener(View.OnClickListener { //openSomeActivityForResult();
            val dialog: Dialog
            dialog = Dialog(
                this@ShopEdit,
                android.R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar_MinWidth
        ...
        spin_country!!.setOnTouchListener(OnTouchListener { v, event ->
            val imm =
    ...
    var someActivityResultLauncher1 = registerForActivityResult<Intent, ActivityResult>(
        ActivityResultContracts.StartActivityForResult()
    ) { result ->
        if (result.resultCode == RESULT_OK) {
            ...
            try {
                ...
                println("print_bitmap== $bitmap")
                println("printbit_uri== $imageUri")
            } catch (e: IOException) {
                e.printStackTrace()
                println("print_error== $e")
            }
            uri_1 = data.data
        }
    }
